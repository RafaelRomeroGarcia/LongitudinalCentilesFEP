...
LocalClinicalAnalisis_GeneralizedLinearModelGauss_V30<-function(D){
  ...
  v<-c('intercept','FEP','time','residual_etiv','Age_inclusion','sexFemale','cpz','FEP:Time','tt:cpz')
  ...
  for(i in 1:length(names_Objetives)){
    ...
    formulaText <- paste0(names_Objetives[[i]], '~dx*Treatment_Time+residual_etiv+Age_inclusion+sex+CPZ_equivalent+CPZ_equivalent:Treatment_Time+(1|Subject)')
